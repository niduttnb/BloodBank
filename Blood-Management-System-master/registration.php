...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; border:2px solid #A7789F; box-shadow:4px 1px 20px black;">
...
<tr><td class="lefttd">Age</td><td><input type="number" name="t2" required="required" min=18 max=55 pattern="[0-9]{2,2}" title="please enter only  numbers between 2 to 2 for age" /></td></tr>
...
<tr><td class="lefttd"> Alternate Email</td><td><input type="email" name="t11" required="required" /></td></tr>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Register" name="sbmt" style="border:0px; background:#A7789F; width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr></table>
</td></tr>
</table>
</form>
        </div>
...
//aloow certain file formats
	if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
		...
		$cn=makeconnection();
			$s="insert into donarregistration(name,gender,age,mobile,b_id,email,alternateEmail,pwd,pic) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $_POST["t11"] . "','" . $_POST["t6"] .  "','" . basename($_FILES["t8"]["name"])  ."')";
