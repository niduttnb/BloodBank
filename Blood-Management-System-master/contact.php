...
<div class="wrap">
    ...
    <div>
<div style="height:500px; width:100%; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#fff; border:2px solid #5F375B; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">


  <div   class="col span_2_of_3"> <div class="contact-form" style="padding-left:100px;">
	
	<div style="font-size: 40px;color: #5F375B;text-align: center;margin-left: 20%;margin-bottom: 10%;"><i> Contact us</i></div>
...
<tr><td class="lefttd"  style="vertical-align:middle">Mobile No</td><td><input type="number" name="t3"   pattern="[0-9]{10,12}" min=1111111111 max=9999999999 title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
